...
// {
//     echo '<script language="javascript">';
//         echo 'alert("You must  login before accessing these page")';
//         echo '</script>';
//         die();
// }
...
$insert=$mysqli->query("INSERT into buy (email,address,pincode,quantity,contact,payment_mode,total,odakh,buyername,category,deliverydate) values ('$email_id','$address','$pincode','$quantity','$contact','$paymentmethod','$total','$odakh','$name','$category','$Date2')");
if($insert)
    {
